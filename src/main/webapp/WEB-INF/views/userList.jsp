...
<div class="page-container">
    <div class="page-header">
        ...
        <div class="header-actions">
            ...
            <%-- The "Create" button from the reference image can be added here if you have a create user page --%>
            <%-- <a href="createUserPage" class="btn btn-primary">Create User</a> --%>
        </div>
    </div>
