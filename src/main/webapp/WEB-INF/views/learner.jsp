  ...
  <div class="container mx-auto px-4">
    <div class="flex items-center justify-between h-20 px-6">
      ...
      <nav class="hidden lg:flex items-center space-x-8">
        ...
        <a href="${pageContext.request.contextPath}${user.role eq 'INSTRUCTOR' ? '/instructor/profile' : '/learner/profile'}" class="text-gray-600 hover:text-indigo-600 font-medium transition-colors">Profile</a>
      </nav>
