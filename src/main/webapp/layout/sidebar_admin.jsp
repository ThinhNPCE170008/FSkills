...
<div class="sidebar-container bg-white border-r border-gray-200 shadow-xl rounded-r-lg p-3">
    ...
    <a href="${pageContext.request.contextPath}/homePage_Guest.jsp" class="flex items-center mb-6 text-decoration-none sidebar-logo text-gray-800" aria-label="F-SKILL Home">
        ...
        <ul class="flex flex-col space-y-2">
            ...
            <li><a class="nav-link flex items-center text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 p-2 rounded-md transition-colors duration-200" href="${pageContext.request.contextPath}/admin/degree" aria-label="Manage Degree"><i class="fas fa-graduation-cap"></i> <span>Manage Degree</span></a></li>
