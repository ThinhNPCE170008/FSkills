    ...
    public User verifyMD5(String UserName, String Password) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                Timestamp BanStatus = rs.getTimestamp("BanStatus");
                int ReportAmount = rs.getInt("ReportAmount");
                String PhoneNumber = rs.getString("PhoneNumber");
                boolean isVerified = rs.getBoolean("IsVerified");
                String GoogleID = rs.getString("GoogleID");

                User acc = new User(UserId, UserName, DisplayName, Email, Password, Role, Gender, TimeCreate, TimeCreate, Avatar, Info, BanStatus, ReportAmount, Info, isVerified, GoogleID);
                return acc;
            }
        } catch (Exception e) {
            System.out.println(e.getMessage());
