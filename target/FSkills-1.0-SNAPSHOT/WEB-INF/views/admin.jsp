            ...
            <nav class="flex-grow">
                <ul>
                    ...
                    <li class="mb-2">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/announcements" class="nav-item flex items-center p-3 rounded-lg transition-all duration-200 hover:bg-gray-900 group">
